      ...
      <div className="rounded-2xl border border-zinc-800 bg-zinc-900/80 backdrop-blur-sm p-8 shadow-2xl">
        ...
        <div className="mb-6 flex flex-col items-center gap-3">
          ...
          <div className="text-center">
            ...
            <p className="mt-0.5 text-sm text-zinc-400">Welcome back — sign in to continue</p>
          </div>
        </div>
        ...
        <form action={formAction} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              required
              autoComplete="email"
              className="border-zinc-700 bg-zinc-800/60 text-white placeholder:text-zinc-600 focus-visible:border-amber-500 focus-visible:ring-amber-500/20"
            />
          </div>
        ...
        <p className="mt-6 text-center text-sm text-zinc-500">
          ...
          <Link href="/signup" className="font-medium text-amber-400 transition-colors hover:text-amber-300">
            Create one
          </Link>
        </p>
      </div>
